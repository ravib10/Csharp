...
private readonly ScenarioContext _scenarioContext;
 public ApiSteps(ScenarioContext scenarioContext)
    ...
    public void GivenIHaveUserId(string userId)
    {
        ...
        Assert.That(true,Is.EqualTo(true),"its pass");
    }
    ...
    public async Task WhenIRequestTheUserDetails()
    {
        ...
        //thi will log into log file
        log.Info("Response is " + _responseBody);
        // log.Info("Response headers are :" + _response.Headers);
        // log.Info("Response headers are :" + _response);
        // //this is how you pass the data in report.
    ...
    {
        //this is how we fetch the environment value. command which we should use is env=PROD dotnet test. Where env is the system environment variable, prod is the environment name
